...
namespace IDMS.Infrastructure.configurations
{
    public class MstBrandsConfiguration: IEntityTypeConfiguration<MstBrands>
    {
        public void Configure(EntityTypeBuilder<MstBrands> builder)
        {
            ...
            builder.HasKey(e => e.Id).HasName("mst_brands_pkey");

            builder.Property(e => e.Id).HasColumnName("id").UseSerialColumn();

            builder.Property(e => e.Code).HasColumnName("code").HasColumnType("varchar(100)").HasMaxLength(10).IsRequeired();

            builder.Property(e => e.Name).HasColumnName("name").HasColumnType("varchar(100)").HasMaxLength(100).IsRequeired();
