...
namespace IDMS.Controllers
{
    ...
    public class MasterGeneralController : Controller
    {
        ...
        [HttpGet("type")]
        public async Task<ActionResult<ApiResponse<object>>> GetType([FromQuery] ReqGetTypeDto dto)
        {
        ...
        [HttpGet("model")]
        public async Task<ActionResult<ApiResponse<object>>> GetModel([FromQuery] ReqGetMstModelDto dto)
        {
