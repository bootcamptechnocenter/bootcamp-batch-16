...
namespace IDMS.Controllers
{
    ...
    public class MasterGeneralController : Controller
    {
        ...
        public MasterGeneralController(IMstBrandService service, IMstTypeService typeService, IMstModelService modelService, IMstStockService stockService)
        {
            _service = service;
        ...
        public async Task<ActionResult<ApiResponse<object>>> DeleteModel(int id)
        {
            ...
            return Ok(ApiResponse<object>.Success(null, result ? "model deleted successfully" : "type not found"));
        }

        [HttpGet("stock")]
        public async Task<ActionResult<ApiResponse<object>>> GetStock([FromQuery] ReqBaseParamDto dto)
        {
        ...
        public async Task<ActionResult<ApiResponse<object>>> UpdateStock([FromBody] ReqUpdateMstStockDto dto, int id)
        {
            ...
            return Ok(ApiResponse<object>.Success(null, result ? "stock updated successfully" : "model not found"));
        }
        ...
        public async Task<ActionResult<ApiResponse<object>>> DeleteStock(int id)
        {
            ...
            return Ok(ApiResponse<object>.Success(null, result ? "stock deleted successfully" : "type not found"));
        }
    }
}