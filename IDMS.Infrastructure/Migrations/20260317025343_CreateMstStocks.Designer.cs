...
namespace IDMS.Infrastructure.Migrations
{
    ...
    [Migration("20260317025343_CreateMstStocks")]
    partial class CreateMstStocks
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IDMS.Shared.Domain.Entities.MstTypes", b =>
                {
                    ...
                    b.ToTable("mst_type", (string)null);
                });

            modelBuilder.Entity("IDMS.Shared.Domain.Entities.MstUsers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
