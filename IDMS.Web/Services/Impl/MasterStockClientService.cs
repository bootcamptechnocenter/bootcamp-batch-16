...
{
    public class MasterStockClientService : IMasterStockService
    {
        ...
        public MasterStockClientService(IHttpClientFactory httpClientFactory, IHttpContextAccessor httpContextAccessor)
        {
