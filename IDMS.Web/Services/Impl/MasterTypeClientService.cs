...
{
    public class MasterTypeClientService : IMasterTypeService
    {
        ...
        public MasterTypeClientService(IHttpClientFactory httpClientFactory, IHttpContextAccessor httpContextAccessor)
        {
