...
{
    public class MstModelClientService : IMasterModelService
    {
        ...
        public MstModelClientService(IHttpClientFactory httpClientFactory, IHttpContextAccessor httpContextAccessor)
        {
