...
{
    public class MstBrandClientService : IMasterBrandClientService
    {
        ...
        public MstBrandClientService(IHttpClientFactory httpClientFactory, IHttpContextAccessor httpContextAccessor)
        {
