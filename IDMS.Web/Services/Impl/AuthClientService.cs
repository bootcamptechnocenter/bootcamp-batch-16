...
namespace IDMS.Web.Services.Impl
{
    public class AuthClientService : IAuthClientService
    {
        ...
        public async Task<(bool Success, string Token, DateTime ExpiresAt, string Message)> LoginAsync(string username, string password)
        {
            ...
            if (!response.IsSuccessStatusCode)
            {
                ...
                return (false, string.Empty, DateTime.MinValue, $"Login failed: {fail?.Message}");
            }
